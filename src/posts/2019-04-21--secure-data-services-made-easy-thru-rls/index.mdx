...
<div style={{ display: block, width: "100%", textAlign: "center" }}>
  <div style={{ margin: "auto", width: 300 }}>
    <img src="./bacon.png" alt="baconz" />
  </div>
</div>
<small style={{ display: block, width: "100%", textAlign: "center" }}>
  bacon. though delicious, completely irrelevant to this post.
</small>
<br />
...
<Caption>
  <a href="https://en.wikipedia.org/wiki/C_Bear_and_Jamal">c-bear, great guy</a>
</Caption>
