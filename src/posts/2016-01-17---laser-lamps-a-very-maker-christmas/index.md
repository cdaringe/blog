...
the <span style="color:blue">blue</span> components are *3mm* thick, and the <span style="color:red">red</span> are the imperial equivalent of *5mm* (~0.19").  **so please note, this is not a single cut file--you must separate the different thickness components** into multiple cuts.
