...
with what data shall we create our post with? because we just installed a variety of plugins, let us observe what data they offer us. the `graphiql` application should be running on [http://localhost:8000/\_\_\_graphql](http://localhost:8000/___graphql) once you've run `npx gatsby develop`.
