...
<Img src="tessl.gif" style={{ width: 350 }} />
<div
  style={{
    display: "block",
    margin: "auto",
...
>
  <a href="https://cdaringe.github.io/tessl">tessl</a>, a tessellation webapp
</div>
...
<br />
<img
  src="https://github.com/cdaringe/d3-svg-path-editor/blob/master/img/demo.mov.gif?raw=true"
...
{/* P=\{p_1,p_2,p_3\} \forall p \in P, distance(p, p_c_u_r_s_o_r) = r */}
