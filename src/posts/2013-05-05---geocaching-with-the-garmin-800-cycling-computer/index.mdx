...
1. Click Menu->Where To?->Locations->(select any location.  I select
   ‘Coordinates’
1. Click the title, i.e. “Coordinates,” in the top of the new screen
1. Click the pencil button to edit the location
1. Select ‘Change Location”
1. Using the on-screen arrows and interface, update the coordinates to your next
   cache!
1. Click the checkbox, and you should be locked on to your destination!
1. Convert to GPS .gpx routes 1. You’re thinking, “huh? A geocache isn’t a
...
1. Visit our friends over at
   [GPSies](http://www.gpsies.com/convert.do "GPSies") and click the “Choose
   File” button.  Select the .loc file.
1. In the “convert to” box below, select GPS Route
1. Click convert and save the .gpx.
1. Plug in your garmin, if you haven’t done so already.  Find the “NewFiles”
   directory, and place your .gpx file in it.
1. Safely remove/eject the garmin and power it on.
1. In the “Courses” menu, you should see your cache!  Click it.
