...
>
  <img
    style={{ bordeRadius: 5, boxShadow: "0px 0px 15px 5px #ccc;" }}
...
`Fancy Titled Engineer` at [WalmartLabs](https://www.walmartlabs.com/)
...
<a
  href="https://static.cdaringe.com/archive/2012/05/scanT.jpg"
  className="img-link"
>
  <img
    src="https://static.cdaringe.com/archive/2012/05/scanT-150x150.jpg"
    className="img-frame float-right"
    width="150"
    height="150"
  />
